...
enum opt_code
{
  ...
  OPT_list = 1597,                           /* -list */
  OPT_mabi_ = 1598,                          /* -mabi= */
  OPT_mabicalls = 1599,                      /* -mabicalls */
  OPT_mabs_ = 1600,                          /* -mabs= */
  OPT_march_ = 1601,                         /* -march= */
  OPT_mbranch_cost_ = 1602,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1603,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1604,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1605,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1606,             /* -mcompact-branches= */
  OPT_mcrc = 1607,                           /* -mcrc */
  OPT_mdebug = 1608,                         /* -mdebug */
  OPT_mdebugd = 1609,                        /* -mdebugd */
  OPT_mdivide_breaks = 1610,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1611,                  /* -mdivide-traps */
  OPT_mdmx = 1612,                           /* -mdmx */
  OPT_mdouble_float = 1613,                  /* -mdouble-float */
  OPT_mdsp = 1614,                           /* -mdsp */
  OPT_mdspr2 = 1615,                         /* -mdspr2 */
  OPT_meb = 1616,                            /* -meb */
  OPT_mel = 1617,                            /* -mel */
  OPT_membedded_data = 1618,                 /* -membedded-data */
  OPT_meva = 1619,                           /* -meva */
  OPT_mexplicit_relocs = 1620,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1621,                  /* -mextern-sdata */
  OPT_mfix_24k = 1622,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1623,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1624,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1625,                     /* -mfix-r4400 */
  OPT_mfix_r5900 = 1626,                     /* -mfix-r5900 */
  OPT_mfix_rm7000 = 1627,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1628,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1629,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1630,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1631,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1632,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1633,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1634,                 /* -mfp-exceptions */
  OPT_mfp32 = 1635,                          /* -mfp32 */
  OPT_mfp64 = 1636,                          /* -mfp64 */
  OPT_mfpxx = 1637,                          /* -mfpxx */
  OPT_mframe_header_opt = 1638,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1639, */              /* -mfused-madd */
  OPT_mginv = 1640,                          /* -mginv */
  OPT_mgp32 = 1641,                          /* -mgp32 */
  OPT_mgp64 = 1642,                          /* -mgp64 */
  OPT_mgpopt = 1643,                         /* -mgpopt */
  OPT_mhard_float = 1644,                    /* -mhard-float */
  OPT_mimadd = 1645,                         /* -mimadd */
  OPT_minterlink_compressed = 1646,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1647,              /* -minterlink-mips16 */
  OPT_mips = 1648,                           /* -mips */
  OPT_mips16 = 1649,                         /* -mips16 */
  OPT_mips3d = 1650,                         /* -mips3d */
  OPT_mllsc = 1651,                          /* -mllsc */
  OPT_mload_store_pairs = 1652,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1653,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1654,                    /* -mlong-calls */
  OPT_mlong32 = 1655,                        /* -mlong32 */
  OPT_mlong64 = 1656,                        /* -mlong64 */
  OPT_mloongson_ext = 1657,                  /* -mloongson-ext */
  OPT_mloongson_ext2 = 1658,                 /* -mloongson-ext2 */
  OPT_mloongson_mmi = 1659,                  /* -mloongson-mmi */
  OPT_mlra = 1660,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1661,                     /* -mlxc1-sxc1 */
  OPT_mmad = 1662,                           /* -mmad */
  OPT_mmadd4 = 1663,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1664,             /* -mmcount-ra-address */
  OPT_mmcu = 1665,                           /* -mmcu */
  OPT_mmemcpy = 1666,                        /* -mmemcpy */
  OPT_mmicromips = 1667,                     /* -mmicromips */
  OPT_mmsa = 1668,                           /* -mmsa */
  OPT_mmt = 1669,                            /* -mmt */
  OPT_mnan_ = 1670,                          /* -mnan= */
  OPT_mno_float = 1671,                      /* -mno-float */
  OPT_mno_flush_func = 1672,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1673,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1674,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1675,                     /* -mno-mips3d */
  OPT_modd_spreg = 1676,                     /* -modd-spreg */
  OPT_mpaired_single = 1677,                 /* -mpaired-single */
  OPT_mplt = 1678,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1679,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1680,               /* -mrelax-pic-calls */
  OPT_mshared = 1681,                        /* -mshared */
  OPT_msingle_float = 1682,                  /* -msingle-float */
  OPT_msmartmips = 1683,                     /* -msmartmips */
  OPT_msoft_float = 1684,                    /* -msoft-float */
  OPT_msplit_addresses = 1685,               /* -msplit-addresses */
  OPT_msym32 = 1686,                         /* -msym32 */
  OPT_msynci = 1687,                         /* -msynci */
  OPT_mtune_ = 1688,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1689,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1690,                          /* -mvirt */
  OPT_mvr4130_align = 1691,                  /* -mvr4130-align */
  OPT_mxgot = 1692,                          /* -mxgot */
  OPT_mxpa = 1693,                           /* -mxpa */
  OPT_n = 1694,                              /* -n */
  OPT_name_sort = 1695,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1696,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1697,              /* -no-integrated-cpp */
  OPT_no_pie = 1698,                         /* -no-pie */
  OPT_noasmopt = 1699,                       /* -noasmopt */
  OPT_nocpp = 1700,                          /* -nocpp */
  OPT_nodefaultlibs = 1701,                  /* -nodefaultlibs */
  OPT_nolibc = 1702,                         /* -nolibc */
  OPT_nophoboslib = 1703,                    /* -nophoboslib */
  OPT_nostartfiles = 1704,                   /* -nostartfiles */
  OPT_nostdinc = 1705,                       /* -nostdinc */
  OPT_nostdinc__ = 1706,                     /* -nostdinc++ */
  OPT_nostdlib = 1707,                       /* -nostdlib */
  OPT_o = 1708,                              /* -o */
  OPT_objects = 1709,                        /* -objects */
  OPT_p = 1710,                              /* -p */
  OPT_pass_exit_codes = 1711,                /* -pass-exit-codes */
  /* OPT_pedantic = 1712, */                 /* -pedantic */
  OPT_pedantic_errors = 1713,                /* -pedantic-errors */
  OPT_pg = 1714,                             /* -pg */
  OPT_pie = 1715,                            /* -pie */
  OPT_pipe = 1716,                           /* -pipe */
  OPT_print_file_name_ = 1717,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1718,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1719,          /* -print-multi-directory */
  OPT_print_multi_lib = 1720,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1721,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1722,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1723,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1724,               /* -print-prog-name= */
  OPT_print_search_dirs = 1725,              /* -print-search-dirs */
  OPT_print_sysroot = 1726,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1727,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1728,                    /* -print-value */
  OPT_quiet = 1729,                          /* -quiet */
  OPT_r = 1730,                              /* -r */
  OPT_remap = 1731,                          /* -remap */
  OPT_reverse_sort = 1732,                   /* -reverse-sort */
  OPT_s = 1733,                              /* -s */
  OPT_save_temps = 1734,                     /* -save-temps */
  OPT_save_temps_ = 1735,                    /* -save-temps= */
  OPT_shared = 1736,                         /* -shared */
  OPT_shared_libgcc = 1737,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1738,               /* -shared-libphobos */
  OPT_size_sort = 1739,                      /* -size-sort */
  /* OPT_specs = 1740, */                    /* -specs */
  OPT_specs_ = 1741,                         /* -specs= */
  OPT_static = 1742,                         /* -static */
  OPT_static_libasan = 1743,                 /* -static-libasan */
  OPT_static_libgcc = 1744,                  /* -static-libgcc */
  OPT_static_libgfortran = 1745,             /* -static-libgfortran */
  OPT_static_libgo = 1746,                   /* -static-libgo */
  OPT_static_liblsan = 1747,                 /* -static-liblsan */
  OPT_static_libmpx = 1748,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1749,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1750,               /* -static-libphobos */
  OPT_static_libstdc__ = 1751,               /* -static-libstdc++ */
  OPT_static_libtsan = 1752,                 /* -static-libtsan */
  OPT_static_libubsan = 1753,                /* -static-libubsan */
  OPT_static_pie = 1754,                     /* -static-pie */
  /* OPT_std_c__03 = 1755, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1756, */                /* -std=c++0x */
  OPT_std_c__11 = 1757,                      /* -std=c++11 */
  OPT_std_c__14 = 1758,                      /* -std=c++14 */
  OPT_std_c__17 = 1759,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1760, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1761, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1762, */                /* -std=c++20 */
  OPT_std_c__2a = 1763,                      /* -std=c++2a */
  OPT_std_c__98 = 1764,                      /* -std=c++98 */
  OPT_std_c11 = 1765,                        /* -std=c11 */
  OPT_std_c17 = 1766,                        /* -std=c17 */
  /* OPT_std_c18 = 1767, */                  /* -std=c18 */
  /* OPT_std_c1x = 1768, */                  /* -std=c1x */
  OPT_std_c2x = 1769,                        /* -std=c2x */
  /* OPT_std_c89 = 1770, */                  /* -std=c89 */
  OPT_std_c90 = 1771,                        /* -std=c90 */
  OPT_std_c99 = 1772,                        /* -std=c99 */
  /* OPT_std_c9x = 1773, */                  /* -std=c9x */
  OPT_std_f2003 = 1774,                      /* -std=f2003 */
  OPT_std_f2008 = 1775,                      /* -std=f2008 */
  OPT_std_f2008ts = 1776,                    /* -std=f2008ts */
  OPT_std_f2018 = 1777,                      /* -std=f2018 */
  OPT_std_f95 = 1778,                        /* -std=f95 */
  OPT_std_gnu = 1779,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1780, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1781, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1782,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1783,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1784,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1785, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1786, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1787, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1788,                    /* -std=gnu++2a */
  ...
  OPT_symbol_ = 1807,                        /* -symbol= */
  OPT_symbolic = 1808,                       /* -symbolic */
  OPT_t = 1809,                              /* -t */
  OPT_time = 1810,                           /* -time */
  OPT_time_ = 1811,                          /* -time= */
  OPT_traditional = 1812,                    /* -traditional */
  OPT_traditional_cpp = 1813,                /* -traditional-cpp */
  OPT_tree_stats = 1814,                     /* -tree-stats */
  OPT_trigraphs = 1815,                      /* -trigraphs */
  OPT_type_stats = 1816,                     /* -type-stats */
  OPT_u = 1817,                              /* -u */
  OPT_undef = 1818,                          /* -undef */
  OPT_v = 1819,                              /* -v */
  OPT_version = 1820,                        /* -version */
  OPT_w = 1821,                              /* -w */
  OPT_wrapper = 1822,                        /* -wrapper */
  OPT_x = 1823,                              /* -x */
  OPT_z = 1824,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
