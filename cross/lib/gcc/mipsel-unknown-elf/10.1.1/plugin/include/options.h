...
enum opt_code
{
  ...
  OPT_mbranch_likely = 1604,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1605,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1606,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1607,             /* -mcompact-branches= */
  OPT_mcrc = 1608,                           /* -mcrc */
  OPT_mdebug = 1609,                         /* -mdebug */
  OPT_mdebugd = 1610,                        /* -mdebugd */
  OPT_mdivide_breaks = 1611,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1612,                  /* -mdivide-traps */
  OPT_mdmx = 1613,                           /* -mdmx */
  OPT_mdouble_float = 1614,                  /* -mdouble-float */
  OPT_mdsp = 1615,                           /* -mdsp */
  OPT_mdspr2 = 1616,                         /* -mdspr2 */
  OPT_meb = 1617,                            /* -meb */
  OPT_mel = 1618,                            /* -mel */
  OPT_membedded_data = 1619,                 /* -membedded-data */
  OPT_meva = 1620,                           /* -meva */
  OPT_mexplicit_relocs = 1621,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1622,                  /* -mextern-sdata */
  OPT_mfix_24k = 1623,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1624,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1625,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1626,                     /* -mfix-r4400 */
  OPT_mfix_r5900 = 1627,                     /* -mfix-r5900 */
  OPT_mfix_rm7000 = 1628,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1629,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1630,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1631,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1632,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1633,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1634,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1635,                 /* -mfp-exceptions */
  OPT_mfp32 = 1636,                          /* -mfp32 */
  OPT_mfp64 = 1637,                          /* -mfp64 */
  OPT_mfpxx = 1638,                          /* -mfpxx */
  OPT_mframe_header_opt = 1639,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1640, */              /* -mfused-madd */
  OPT_mginv = 1641,                          /* -mginv */
  OPT_mgp32 = 1642,                          /* -mgp32 */
  OPT_mgp64 = 1643,                          /* -mgp64 */
  OPT_mgpopt = 1644,                         /* -mgpopt */
  OPT_mhard_float = 1645,                    /* -mhard-float */
  OPT_mimadd = 1646,                         /* -mimadd */
  OPT_minterlink_compressed = 1647,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1648,              /* -minterlink-mips16 */
  OPT_mips = 1649,                           /* -mips */
  OPT_mips16 = 1650,                         /* -mips16 */
  OPT_mips3d = 1651,                         /* -mips3d */
  OPT_mllsc = 1652,                          /* -mllsc */
  OPT_mload_store_pairs = 1653,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1654,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1655,                    /* -mlong-calls */
  OPT_mlong32 = 1656,                        /* -mlong32 */
  OPT_mlong64 = 1657,                        /* -mlong64 */
  OPT_mloongson_ext = 1658,                  /* -mloongson-ext */
  OPT_mloongson_ext2 = 1659,                 /* -mloongson-ext2 */
  OPT_mloongson_mmi = 1660,                  /* -mloongson-mmi */
  OPT_mlra = 1661,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1662,                     /* -mlxc1-sxc1 */
  OPT_mmad = 1663,                           /* -mmad */
  OPT_mmadd4 = 1664,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1665,             /* -mmcount-ra-address */
  OPT_mmcu = 1666,                           /* -mmcu */
  OPT_mmemcpy = 1667,                        /* -mmemcpy */
  OPT_mmicromips = 1668,                     /* -mmicromips */
  OPT_mmsa = 1669,                           /* -mmsa */
  OPT_mmt = 1670,                            /* -mmt */
  OPT_mnan_ = 1671,                          /* -mnan= */
  OPT_mno_float = 1672,                      /* -mno-float */
  OPT_mno_flush_func = 1673,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1674,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1675,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1676,                     /* -mno-mips3d */
  OPT_modd_spreg = 1677,                     /* -modd-spreg */
  OPT_mpaired_single = 1678,                 /* -mpaired-single */
  OPT_mplt = 1679,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1680,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1681,               /* -mrelax-pic-calls */
  OPT_mshared = 1682,                        /* -mshared */
  OPT_msingle_float = 1683,                  /* -msingle-float */
  OPT_msmartmips = 1684,                     /* -msmartmips */
  OPT_msoft_float = 1685,                    /* -msoft-float */
  OPT_msplit_addresses = 1686,               /* -msplit-addresses */
  OPT_msym32 = 1687,                         /* -msym32 */
  OPT_msynci = 1688,                         /* -msynci */
  OPT_mtune_ = 1689,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1690,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1691,                          /* -mvirt */
  OPT_mvr4130_align = 1692,                  /* -mvr4130-align */
  OPT_mxgot = 1693,                          /* -mxgot */
  OPT_mxpa = 1694,                           /* -mxpa */
  OPT_n = 1695,                              /* -n */
  OPT_name_sort = 1696,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1697,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1698,              /* -no-integrated-cpp */
  OPT_no_pie = 1699,                         /* -no-pie */
  OPT_noasmopt = 1700,                       /* -noasmopt */
  OPT_nocpp = 1701,                          /* -nocpp */
  OPT_nodefaultlibs = 1702,                  /* -nodefaultlibs */
  OPT_nolibc = 1703,                         /* -nolibc */
  OPT_nophoboslib = 1704,                    /* -nophoboslib */
  OPT_nostartfiles = 1705,                   /* -nostartfiles */
  OPT_nostdinc = 1706,                       /* -nostdinc */
  OPT_nostdinc__ = 1707,                     /* -nostdinc++ */
  OPT_nostdlib = 1708,                       /* -nostdlib */
  OPT_o = 1709,                              /* -o */
  OPT_objects = 1710,                        /* -objects */
  OPT_p = 1711,                              /* -p */
  OPT_pass_exit_codes = 1712,                /* -pass-exit-codes */
  /* OPT_pedantic = 1713, */                 /* -pedantic */
  OPT_pedantic_errors = 1714,                /* -pedantic-errors */
  OPT_pg = 1715,                             /* -pg */
  OPT_pie = 1716,                            /* -pie */
  OPT_pipe = 1717,                           /* -pipe */
  OPT_print_file_name_ = 1718,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1719,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1720,          /* -print-multi-directory */
  OPT_print_multi_lib = 1721,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1722,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1723,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1724,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1725,               /* -print-prog-name= */
  OPT_print_search_dirs = 1726,              /* -print-search-dirs */
  OPT_print_sysroot = 1727,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1728,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1729,                    /* -print-value */
  OPT_quiet = 1730,                          /* -quiet */
  OPT_r = 1731,                              /* -r */
  OPT_remap = 1732,                          /* -remap */
  OPT_reverse_sort = 1733,                   /* -reverse-sort */
  OPT_s = 1734,                              /* -s */
  OPT_save_temps = 1735,                     /* -save-temps */
  OPT_save_temps_ = 1736,                    /* -save-temps= */
  OPT_shared = 1737,                         /* -shared */
  OPT_shared_libgcc = 1738,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1739,               /* -shared-libphobos */
  OPT_size_sort = 1740,                      /* -size-sort */
  /* OPT_specs = 1741, */                    /* -specs */
  OPT_specs_ = 1742,                         /* -specs= */
  OPT_static = 1743,                         /* -static */
  OPT_static_libasan = 1744,                 /* -static-libasan */
  OPT_static_libgcc = 1745,                  /* -static-libgcc */
  OPT_static_libgfortran = 1746,             /* -static-libgfortran */
  OPT_static_libgo = 1747,                   /* -static-libgo */
  OPT_static_liblsan = 1748,                 /* -static-liblsan */
  OPT_static_libmpx = 1749,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1750,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1751,               /* -static-libphobos */
  OPT_static_libstdc__ = 1752,               /* -static-libstdc++ */
  OPT_static_libtsan = 1753,                 /* -static-libtsan */
  OPT_static_libubsan = 1754,                /* -static-libubsan */
  OPT_static_pie = 1755,                     /* -static-pie */
  /* OPT_std_c__03 = 1756, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1757, */                /* -std=c++0x */
  OPT_std_c__11 = 1758,                      /* -std=c++11 */
  OPT_std_c__14 = 1759,                      /* -std=c++14 */
  OPT_std_c__17 = 1760,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1761, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1762, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1763, */                /* -std=c++20 */
  OPT_std_c__2a = 1764,                      /* -std=c++2a */
  OPT_std_c__98 = 1765,                      /* -std=c++98 */
  OPT_std_c11 = 1766,                        /* -std=c11 */
  OPT_std_c17 = 1767,                        /* -std=c17 */
  /* OPT_std_c18 = 1768, */                  /* -std=c18 */
  /* OPT_std_c1x = 1769, */                  /* -std=c1x */
  OPT_std_c2x = 1770,                        /* -std=c2x */
  /* OPT_std_c89 = 1771, */                  /* -std=c89 */
  OPT_std_c90 = 1772,                        /* -std=c90 */
  OPT_std_c99 = 1773,                        /* -std=c99 */
  /* OPT_std_c9x = 1774, */                  /* -std=c9x */
  OPT_std_f2003 = 1775,                      /* -std=f2003 */
  OPT_std_f2008 = 1776,                      /* -std=f2008 */
  OPT_std_f2008ts = 1777,                    /* -std=f2008ts */
  OPT_std_f2018 = 1778,                      /* -std=f2018 */
  OPT_std_f95 = 1779,                        /* -std=f95 */
  OPT_std_gnu = 1780,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1781, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1782, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1783,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1784,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1785,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1786, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1787, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1788, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1789,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1790,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1791,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1792,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1793, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1794, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1795,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1796, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1797,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1798,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1799, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1800, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1801,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1802, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1803, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1804, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1805, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1806, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1807,                     /* -std=legacy */
